...
namespace UnitGenerator
{
 ...
 if (HasFlag(UnitGenerateOptions.NewtonsoftJsonConvert)) { 
 ...
 if (HasFlag(UnitGenerateOptions.NewtonsoftJsonConvert)) { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(Name));
            this.Write("NewtonsoftJsonConverter))]\r\n");
 } 
 ...
 if (HasFlag(UnitGenerateOptions.JsonConverter)) { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(Name));
            this.Write("JsonConverter : System.Text.Json.Serialization.JsonConverter<");
            this.Write(this.ToStringHelper.ToStringWithCulture(Name));
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(Type));
            this.Write(")) as System.Text.Json.Serialization.JsonConverter<");
            this.Write(this.ToStringHelper.ToStringWithCulture(Type));
            this.Write(@">;
                if (converter != null)
                {
                ...
                {
                    throw new System.Text.Json.JsonException($""{typeof(");
            this.Write(this.ToStringHelper.ToStringWithCulture(Type));
            ...
            this.Write("(converter.Read(ref reader, typeToConvert, options));\r\n                }\r\n       " +
                    "         else\r\n                {\r\n                    throw new System.Text.Json" +
                    ".JsonException($\"{typeof(");
            this.Write(this.ToStringHelper.ToStringWithCulture(Type));
            this.Write(")} converter does not found.\");\r\n                }\r\n            }\r\n\r\n");
...
if (IsSupportUtf8Formatter()) {  
 ...
 if (HasFlag(UnitGenerateOptions.EntityFrameworkValueConverter)) { 
            ...
            this.Write("\r\n");
 if (HasFlag(UnitGenerateOptions.NewtonsoftJsonConvert)) { 
            this.Write(" \r\n        // UnitGenerateOptions.NewtonsoftJsonConverter\r\n        private class " +
                    "");
            this.Write(this.ToStringHelper.ToStringWithCulture(Name));
            this.Write("NewtonsoftJsonConverter : Newtonsoft.Json.JsonConverter<");
            this.Write(this.ToStringHelper.ToStringWithCulture(Name));
...
if (IsUlid()) { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(Name));
            this.Write(" existingValue, bool hasExistingValue, Newtonsoft.Json.JsonSerializer serializer)" +
                    "\r\n            {\r\n                return new ");
            this.Write(this.ToStringHelper.ToStringWithCulture(Name));
